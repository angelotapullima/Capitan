...
public class AdapterEquiposTorneo extends RecyclerView.Adapter<AdapterEquiposTorneo.EquiposTorneoViewHolder>  {

    UniversalImageLoader universalImageLoader;
    EquiposTorneo current;
    Context ctx;
    private  OnItemClickListener listener;
    Preferences preferencesUser;


    class EquiposTorneoViewHolder extends RecyclerView.ViewHolder {
        ...
        private EquiposTorneoViewHolder(View itemView) {
            super(itemView);
        ...
        public void bid(final EquiposTorneo mequipos,final OnItemClickListener listener){
    ...
    private List<EquiposTorneo> mUsers; // Cached copy of users


    public AdapterEquiposTorneo(Context context, OnItemClickListener listener) {
        this.ctx=context;
    ...
    @NonNull
    @Override
    public EquiposTorneoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.rcv_item_list_equipos_general_retar, parent, false);
        return new EquiposTorneoViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(@NonNull final EquiposTorneoViewHolder holder, int position) {
        if (mUsers != null) {
    ...
    public void setWords(List<EquiposTorneo> users){
        mUsers = users;
    ...
    public interface  OnItemClickListener{
        void onItemClick(EquiposTorneo mequipos, int position);
    }
