...
public class MasEquipos extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void buscar(String v) {
        ...
        busquedaEquiposWebServiceRepository.providesWebService("busqueda",preferences.getIdUsuarioPref(),v,preferences.getToken());
    }
    public void cargarvista(){

        busquedaEquiposViewModel.getAll().observe(this, new Observer<List<BusquedaEquipos>>() {
            @Override
    ...
    private void setAdapter(){
        ...
        adaptadorBusquedaEquipos = new AdaptadorBusquedaEquipos(this, new AdaptadorBusquedaEquipos.OnItemClickListener() {
            @Override
    ...
    public void onRefresh() {
        ...
        BusquedaEquiposWebServiceRepository busquedaEquiposWebServiceRepository = new BusquedaEquiposWebServiceRepository(application);
        busquedaEquiposWebServiceRepository.providesWebService("carga",preferences.getIdUsuarioPref(),"",preferences.getToken());
