...
public class FragmentPasMañana extends Fragment  implements  SwipeRefreshLayout.OnRefreshListener {
    ...
    public  String fecha_actual_mas_dos_insert;
    public Date date;
    public SwipeRefreshLayout swipeRefreshLayout;


    String separador,part1,part2,separador_part1,part1_res,h_apertura,h_cierre,string_apertura,h_reserva,hora,horaFinal= "";
                        ...
                        if (neo_hora.length()!=2){
                            if (i == Integer.parseInt(neo_hora.substring(0, 1))) {
                                ...
                                if (obj.getReserva_estado().equals("1")){
                                    ...
                                    arrayreservados.add(new Reserva(obj.getReserva_id(), cancha_id, obj.getReserva_nombre(), fecha_actual_mas_dos_insert, horaFinal, String.valueOf(pago), "rojo" , "Reservado", precio_noche, h_reserva));

                                }else{
                                    arrayreservados.add(new Reserva(obj.getReserva_id(), cancha_id, obj.getReserva_nombre(), fecha_actual_mas_dos_insert, horaFinal, String.valueOf(pago), "anaranjado" , "Reservado", precio_noche, h_reserva));
                        ...
                        if (neo_hora.length()!=2){
                            ...
                            if (i == Integer.parseInt(neo_hora.substring(0, 1))) {
                                ...
                                if (obj.getReserva_estado().equals("1")){
                                    ...
                                    arrayreservados.add(new Reserva(obj.getReserva_id(), cancha_id, obj.getReserva_nombre(), fecha_actual_mas_dos_insert, horaFinal,  String.valueOf(pago),"anaranjado", "Reservado", precio_dia, h_reserva));
                    ...
                    if (tipo.equals("imb_reserva_llamada")){
                        ...
                        if (reserva.getReserva_color().equals("rojo")){
                            ...
                            if (tipo_usuario.equals("admin")){
                                ...
                                i.putExtra("fecha",fecha_actual_mas_dos_insert);
