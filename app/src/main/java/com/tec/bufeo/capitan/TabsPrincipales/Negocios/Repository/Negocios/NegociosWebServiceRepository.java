package com.tec.bufeo.capitan.TabsPrincipales.Negocios.Repository.Negocios;
...
import com.tec.bufeo.capitan.TabsPrincipales.Negocios.Model.Ratings;
    ...
    private List<Negocios> parseJson(String response ) {
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                negocios.setLatitud(jsonNode.optString("lat"));
                negocios.setLongitud(jsonNode.optString("lon"));
