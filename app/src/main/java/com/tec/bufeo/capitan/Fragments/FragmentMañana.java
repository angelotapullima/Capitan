...
public class FragmentMañana extends Fragment implements  SwipeRefreshLayout.OnRefreshListener {
    ...
    public static void actualizarReserva(){
        ...
        dc = new DataConnection(activity, "listarcanchasReservas", new Reserva(cancha_id), fecha_actual_mas_uno_insert, false);
        new FragmentMañana.GetReservados().execute();
                    ...
                    for(Reserva obj:arrayreservados_WS){
                        ...
                        if(hora.length() ==11) {
                            ...
                            if (i == Integer.parseInt(hora.substring(0, 2))) {
                                reservado_pm = true;
                                arrayreservados.add(new Reserva("", cancha_id, obj.getReserva_nombre(), fecha_actual_mas_uno_insert, horaFinal, obj.getReserva_costo(), Integer.parseInt(precio_noche) == Integer.parseInt(obj.getReserva_costo()) ? "rojo" : "anaranjado", "Reservado", precio_noche, h_reserva));
                            }
                        }
                        else{
                    ...
                    for(Reserva obj:arrayreservados_WS){
                        ...
                        if(hora.length() ==11) {
                            ...
                            if (i == Integer.parseInt(hora.substring(0, 2))) {
                                ...
                                arrayreservados.add(new Reserva("", cancha_id, obj.getReserva_nombre(), fecha_actual_mas_uno_insert, horaFinal, obj.getReserva_costo(), Integer.parseInt(precio_dia) == Integer.parseInt(obj.getReserva_costo()) ? "rojo" : "anaranjado", "Reservado", precio_dia, h_reserva));
                            }
                        }
                        else{
