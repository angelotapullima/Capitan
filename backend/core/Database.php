...
class Database{
    ...
    public static function getConnection(){
        try{
            if(empty(self::$db)){
                //$pdo = new PDO('mysql:host=guabba.com;dbname=guabba_salubridad;charset=utf8mb4','guabba_saludos','12345678');
                //$pdo = new PDO('mysql:host=localhost;dbname=capitan;charset=utf8','root','');
                $pdo = new PDO('mysql:host=192.185.25.45;dbname=guabba_capitan2;charset=utf8mb4','guabba_root','Aa12345678');
