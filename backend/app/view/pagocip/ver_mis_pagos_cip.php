...
?>
    <div class="row">
        <div class="col-xs-10">
            <center><h2>Lista de Pagos realizados</h2></center>
        </div>
        <div class="col-xs-2">
            <center><a class="btn btn-block btn-success btn-sm" href="<?php echo _SERVER_;?>PagoCIP/pagar_cip" >Pagar CIP</a></center>
        </div>
    </div>
    <br>
    <!-- /.row (main row) -->
