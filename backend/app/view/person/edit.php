            ...
            <div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="person_dni" value="<?php echo $person->person_dni;?>" readonly maxlength="8">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-success" onclick="save()"> Editar Persona</button>
                    </div>
                </div>
                <!-- /.box-body -->
            </div>
