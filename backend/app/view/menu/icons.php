...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">66 Nuevos Iconos en 4.4</h4>
                <div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Aplicaciones Web Iconos</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Mano</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-hand-grab-o"></i>
                            hand-grab-o <span class="text-muted">(alias)</span></a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Transporte</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Género</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-genderless"></i>
                            genderless</a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Tipo de Archivo</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Giro</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-circle-o-notch"></i>
                            circle-o-notch</a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Formulario</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-check-square"></i>
                            check-square</a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Pago</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos Chart</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-area-chart"></i>
                            area-chart</a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Moneda</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Editor de Texto</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Direcciones</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Reproducción de Video</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-arrows-alt"></i>
                            arrows-alt</a></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos de Marca</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-500px"></i> 500px</a></div>
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Iconos Médicos</h4>
                <div class="row">
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-ambulance"></i> ambulance</a></div>
                    <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
