...
<main class="bsod container">
    ...
    <p>* Volver al inicio.<br />
        * Ponerte en contacto con el equipo de trabajo.</p>
    <nav class="nav">
        <a href="<?php echo _SERVER_;?>" class="link">Inicio</a>&nbsp;|&nbsp;<a href="<?php echo _MYSITE_;?>" class="link" target="_blank">Ir al equipo</a>
    </nav>
</main>

<!--con el que hizo esto y p***arlo(s) por el error.-->
</body>
